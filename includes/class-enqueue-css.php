...
class Enqueue_CSS {
	...
	public function enqueue_assets() {
		$dynamic_css_priority = apply_filters( 'Dynamic_CSS_priority', 10 );
	...
	public function enqueue_dynamic_css() {
		...
		if ( 'file' === $this->mode() ) {
			wp_enqueue_style( 'shop-cred', esc_url( $this->file( 'uri' ) ), array(), time() ); // phpcs:ignore WordPress.WP.EnqueuedResourceParameters.MissingVersion
		}
	}
	...
	public function print_inline_css() {
		if ( 'inline' === $this->mode() || ! wp_style_is( 'shop-cred', 'enqueued' ) ) {
			$css = GenerateCSS::get_frontend_block_css();
	...
	public function print_inline_js() {
		if ( 'inline' === $this->mode() ) {
			$content = Block_Data::get_parsed_content();
			$js = GenerateCSS::get_dynamic_js($content);
	...
	public function make_css() {
		...
		$content = GenerateCSS::get_frontend_block_css();
	...
	public function add_options() {
		 ...
		 */
		add_option( 'Dynamic_CSS_posts', array(), '', 'yes' );
