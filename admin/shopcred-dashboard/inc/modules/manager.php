...
class Manager {
	...
	public function __construct() {
		...
		$this->registered_category = apply_filters( 'shopcred-dashboard/module-manager/registered-module-category', array(
			'other' => array(
				'name'     => 'Other',
				'slug'     => 'other',
				'priority' => 100
		...
		$this->registered_page_modules = apply_filters( 'shopcred-dashboard/module-manager/registered-page-modules', array(
			'welcome-page' => array(
				'class' => '\\ShopCred\\Modules\\Welcome\\Module',
				'args'  => array(),
			),
			'settings-page' => array(
				'class' => '\\ShopCred\\Modules\\Settings\\Module',
				'args'  => array(),
			),
		
		) );

		$this->registered_subpage_modules = apply_filters( 'shopcred-dashboard/module-manager/registered-subpage-modules', array(
			'dev-test-page' => array(
				'class' => '\\ShopCred\\Modules\\Welcome\\Dev_Test',
				'args'  => array(),
			),
		) );
