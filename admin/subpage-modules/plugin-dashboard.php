...
class Plugin_Dashboard extends Page_Module_Base {

	public function get_page_slug() {

		return 'shopcred-plugin-dashboard';
	}
	...
	public function get_page_name() {
		...
		return esc_html__( 'Dashboard', 'ShopCred' );
	}
	...
	public function page_templates( $templates = array(), $page = false, $subpage = false ) {
		...
		$templates['shopcred-plugin-dashboard'] = base_init()->plugin_admin_path( 'templates/settings-templates/plugin-dashboard.php' );
